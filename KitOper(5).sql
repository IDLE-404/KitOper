...
--
-- Хост: db
-- Время создания: Ноя 23 2025 г., 19:26
...
CREATE TABLE `first_course_schedules` (
  `id` bigint UNSIGNED NOT NULL,
  `study_day` enum('Понедельник','Вторник','Среда','Четверг','Пятница') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
('9J8cv5P06W0KPfT7RsOMNgaMAJErajaQRSiRiMyo', NULL, '172.31.0.1', 'Mozilla/5.0 (X11; Linux x86_64; rv:145.0) Gecko/20100101 Firefox/145.0', '', 1763925855);
